...
public class ResumeTestData {
    ...
    private static void fillContacts(Resume resume, int count) {
        ...
        String[] values = new String[]{"+7(999) 000-1100","aleksandr_chistov","aleksandrchistov.ru@yandex.ru","https://www.linkedin.com/in/alexanderchistov/","https://github.com/AleksandrChistov","https://stackoverflow.com/","https://yandex.ru/"};
